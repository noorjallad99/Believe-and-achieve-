 ...
 * @author alanwar
 */
public class doctorActivities extends javax.swing.JFrame {

    /**
     * Creates new form doctorActivities
     */
    public doctorActivities() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Patient Name ", "Patient Name", "Date", "Time", "Operration"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(doctorActivities.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new doctorActivities().setVisible(true);
            }
        });
    }
